...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('permissionName', set_value('permissionname',$permission_details->permissionName) , array('class' => 'form-control', 'placeholder' => 'Permission Name', 'id' => 'permissionname')); ?>
		...
		<div class="form-group">
			...
			<?php echo form_input('permissionDesc', set_value('permissiondesc',$permission_details->permissionDesc) , array('class' => 'form-control', 'placeholder' => 'Permission Description', 'id' => 'permissiondesc')); ?>
		...
		<div class="form-group">
			...
			<?php echo form_input('permissionCode', set_value('permissionCode',$permission_details->permissionCode) , array('class' => 'form-control', 'placeholder' => 'Permission Code', 'id' => 'permissionCode')); ?>
